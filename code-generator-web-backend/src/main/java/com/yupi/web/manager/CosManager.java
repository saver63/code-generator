...
public class CosManager {
    ...
    //bean加载完成后时执行，为什么？因为要用到cosClient，而cosClient是作为一个Bean引入，要等Bean加载完成后再执行init方法中的transferManager
    @PostConstruct
    public void init(){
     ...
     * @return
     */
    public PutObjectResult putObjectTest(String key, String localFilePath) {
